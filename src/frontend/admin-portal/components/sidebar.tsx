...
import { ShieldAlert, LayoutDashboard, ScrollText, Lock, Trash2, LogOut, Menu, X, User } from "lucide-react";

const navItems = [
  { href: "/", label: "Dashboard", icon: LayoutDashboard },
  { href: "/audit", label: "Audit Export", icon: ScrollText },
  { href: "/legal-holds", label: "Legal Holds", icon: Lock },
